...
// ***********************************************************************
// <copyright file="SchemeCreator.cs" company="Zeroit Dev Technlologies">
...
namespace Zeroit.Framework.MaterialWinforms.Controls.Settings
{
    ...
    public partial class SchemeCreator : Form
    {
        ...
        /// <summary>
        /// The light primary rect
        /// </summary>
        private Rectangle LightPrimaryRect;
        /// <summary>
        /// The dark primary rect
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemeCreator"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Handles the LocationChanged event of the BaseFormToOverlay control.
        /// </summary>
        ...
        /// <summary>
        /// Handles the MouseUp event of the SchemeCreator control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        ...
        /// <summary>
        /// Handles the TextChanged event of the objText control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
    ...
    class CurrentThemePreview
    {
        ...
        private Size Size;
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentThemePreview"/> class.
        /// </summary>
