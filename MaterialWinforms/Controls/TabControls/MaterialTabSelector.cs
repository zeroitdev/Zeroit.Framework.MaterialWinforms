...
// ***********************************************************************
// <copyright file="MaterialTabSelector.cs" company="Zeroit Dev Technlologies">
...
namespace Zeroit.Framework.MaterialWinforms.Controls
{
    ...
    public class MaterialTabSelector : Control, IShadowedMaterialControl
    {
        ...
        /// <summary>
        /// The hovered x button index
        /// </summary>
        private int HoveredXButtonIndex = -1;
        /// <summary>
        /// Gets or sets the right click menu.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the maximum tab widht.
        /// </summary>
        /// <value>The maximum tab widht.</value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [center tabs].
        /// </summary>
        /// <value><c>true</c> if [center tabs]; otherwise, <c>false</c>.</value>
        ...
        /// <summary>
        /// Handles the Click event of the OpenInNewWindow control.
        /// </summary>
        ...
        /// <summary>
        /// Handles the Click event of the CloseAllExeptCurrent control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        ...
        /// <summary>
        /// Handles the Click event of the TabPositionZurruecksetzten control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        ...
        /// <summary>
        /// Handles the Click event of the CloseAllTabs control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
